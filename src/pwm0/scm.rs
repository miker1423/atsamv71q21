...
pub enum UPDM_A {
    ...
    MODE1 = 1,
    #[doc = "2: Automatic write of duty-cycle update registers by the DMA and automatic update of synchronous channels"]
    MODE2 = 2,
}
...
impl<'a> UPDM_W<'a> {
    ...
    #[doc = "Automatic write of duty-cycle update registers by the DMA and automatic update of synchronous channels"]
    #[inline(always)]
...
#[doc = "Field `PTRM` reader - DMA Transfer Request Mode"]
...
#[doc = "Field `PTRM` writer - DMA Transfer Request Mode"]
pub struct PTRM_W<'a> {
    w: &'a mut W,
}
impl<'a> PTRM_W<'a> {
...
#[doc = "Field `PTRCS` reader - DMA Transfer Request Comparison Selection"]
...
#[doc = "Field `PTRCS` writer - DMA Transfer Request Comparison Selection"]
...
impl R {
    ...
    #[doc = "Bit 20 - DMA Transfer Request Mode"]
    #[inline(always)]
    pub fn ptrm(&self) -> PTRM_R {
        PTRM_R::new(((self.bits >> 20) & 0x01) != 0)
    }
    #[doc = "Bits 21:23 - DMA Transfer Request Comparison Selection"]
    #[inline(always)]
