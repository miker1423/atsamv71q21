...
impl core::convert::From<crate::R<R2Y_SET2_SPEC>> for R {
...
impl core::convert::From<crate::W<R2Y_SET2_SPEC>> for W {
...
#[doc = "`reset()` method sets R2Y_SET2 to value 0x0138_4a4b"]
