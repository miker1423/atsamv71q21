...
impl core::convert::From<crate::R<Y2R_SET0_SPEC>> for R {
...
impl core::convert::From<crate::W<Y2R_SET0_SPEC>> for W {
...
#[doc = "`reset()` method sets Y2R_SET0 to value 0x6832_cc95"]
