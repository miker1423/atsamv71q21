...
impl core::convert::From<crate::R<R2Y_SET1_SPEC>> for R {
...
impl core::convert::From<crate::W<R2Y_SET1_SPEC>> for W {
...
#[doc = "`reset()` method sets R2Y_SET1 to value 0x0124_5e38"]
