...
pub struct RegisterBlock {
    ...
    #[doc = "0x8c - Specific Address 1 Top Register"]
    pub sat1: crate::Reg<sat1::SAT1_SPEC>,
    #[doc = "0x90 - Specific Address 2 Bottom Register"]
    pub sab2: crate::Reg<sab2::SAB2_SPEC>,
    #[doc = "0x94 - Specific Address 2 Top Register"]
    pub sat2: crate::Reg<sat2::SAT2_SPEC>,
    #[doc = "0x98 - Specific Address 3 Bottom Register"]
    pub sab3: crate::Reg<sab3::SAB3_SPEC>,
    #[doc = "0x9c - Specific Address 3 Top Register"]
    pub sat3: crate::Reg<sat3::SAT3_SPEC>,
    #[doc = "0xa0 - Specific Address 4 Bottom Register"]
    pub sab4: crate::Reg<sab4::SAB4_SPEC>,
    #[doc = "0xa4 - Specific Address 4 Top Register"]
    ...
    #[doc = "0x14c - Carrier Sense Errors Register Register"]
    ...
    _reserved105: [u8; 512usize],
    #[doc = "0x400 - Interrupt Status Register Priority Queue (index = 1)"]
    pub isrpq: [crate::Reg<isrpq::ISRPQ_SPEC>; 3],
    _reserved106: [u8; 52usize],
    #[doc = "0x440 - Transmit Buffer Queue Base Address Register Priority Queue (index = 1)"]
    pub tbqbapq: [crate::Reg<tbqbapq::TBQBAPQ_SPEC>; 3],
    _reserved107: [u8; 52usize],
    #[doc = "0x480 - Receive Buffer Queue Base Address Register Priority Queue (index = 1)"]
    pub rbqbapq: [crate::Reg<rbqbapq::RBQBAPQ_SPEC>; 3],
    _reserved108: [u8; 20usize],
    #[doc = "0x4a0 - Receive Buffer Size Register Priority Queue (index = 1)"]
    pub rbsrpq: [crate::Reg<rbsrpq::RBSRPQ_SPEC>; 3],
    ...
    #[doc = "0x500 - Screening Type 1 Register Priority Queue (index = 0)"]
    pub st1rpq: [crate::Reg<st1rpq::ST1RPQ_SPEC>; 4],
    _reserved113: [u8; 48usize],
    #[doc = "0x540 - Screening Type 2 Register Priority Queue (index = 0)"]
    pub st2rpq: [crate::Reg<st2rpq::ST2RPQ_SPEC>; 8],
    _reserved114: [u8; 160usize],
    #[doc = "0x600 - Interrupt Enable Register Priority Queue (index = 1)"]
    pub ierpq: [crate::Reg<ierpq::IERPQ_SPEC>; 3],
    _reserved115: [u8; 20usize],
    #[doc = "0x620 - Interrupt Disable Register Priority Queue (index = 1)"]
    pub idrpq: [crate::Reg<idrpq::IDRPQ_SPEC>; 3],
    _reserved116: [u8; 20usize],
    #[doc = "0x640 - Interrupt Mask Register Priority Queue (index = 1)"]
    pub imrpq: [crate::Reg<imrpq::IMRPQ_SPEC>; 3],
    _reserved117: [u8; 148usize],
    #[doc = "0x6e0 - Screening Type 2 Ethertype Register (index = 0)"]
...
#[doc = "Carrier Sense Errors Register Register"]
pub mod cse;
...
#[doc = "Interrupt Status Register Priority Queue (index = 1)"]
pub mod isrpq;
