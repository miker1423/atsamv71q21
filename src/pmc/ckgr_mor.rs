...
#[repr(u8)]
pub enum MOSCRCF_A {
    #[doc = "0: Fast RC oscillator frequency is at 4 MHz (default)"]
    _4_MHZ = 0,
    #[doc = "1: Fast RC oscillator frequency is at 8 MHz"]
    _8_MHZ = 1,
    #[doc = "2: Fast RC oscillator frequency is at 12 MHz"]
    _12_MHZ = 2,
}
...
impl<'a> MOSCRCF_W<'a> {
    ...
    #[doc = "Fast RC oscillator frequency is at 4 MHz (default)"]
    #[inline(always)]
    pub fn _4_mhz(self) -> &'a mut W {
        self.variant(MOSCRCF_A::_4_MHZ)
    }
    #[doc = "Fast RC oscillator frequency is at 8 MHz"]
    #[inline(always)]
    pub fn _8_mhz(self) -> &'a mut W {
        self.variant(MOSCRCF_A::_8_MHZ)
    }
    #[doc = "Fast RC oscillator frequency is at 12 MHz"]
    #[inline(always)]
