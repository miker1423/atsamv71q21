...
impl core::convert::From<crate::R<FBTP_SPEC>> for R {
...
impl core::convert::From<crate::W<FBTP_SPEC>> for W {
...
#[doc = "Field `TDCO` reader - Transce iver Delay Compensation Offset"]
...
#[doc = "Field `TDCO` writer - Transce iver Delay Compensation Offset"]
pub struct TDCO_W<'a> {
    w: &'a mut W,
}
impl<'a> TDCO_W<'a> {
...
impl R {
    ...
    #[doc = "Bits 24:28 - Transce iver Delay Compensation Offset"]
    #[inline(always)]
...
#[doc = "`reset()` method sets FBTP to value 0x0a33"]
