...
impl NBBITS_R {
    ...
    pub fn variant(&self) -> Option<NBBITS_A> {
        match self.bits {
            ...
            1 => Some(NBBITS_A::_9_BIT),
            2 => Some(NBBITS_A::_10_BIT),
            3 => Some(NBBITS_A::_11_BIT),
            4 => Some(NBBITS_A::_12_BIT),
            5 => Some(NBBITS_A::_13_BIT),
            6 => Some(NBBITS_A::_14_BIT),
            7 => Some(NBBITS_A::_15_BIT),
