...
impl NBBITS_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, NBBITS_A> {
        ...
        match self.bits {
            ...
            1 => Val(NBBITS_A::_9_BIT),
            2 => Val(NBBITS_A::_10_BIT),
            3 => Val(NBBITS_A::_11_BIT),
            4 => Val(NBBITS_A::_12_BIT),
            5 => Val(NBBITS_A::_13_BIT),
            6 => Val(NBBITS_A::_14_BIT),
            7 => Val(NBBITS_A::_15_BIT),
