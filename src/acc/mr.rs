...
impl SELMINUS_R {
    ...
    #[doc = "Checks if the value of the field is `ADVREFP`"]
    #[inline(always)]
    pub fn is_advrefp(&self) -> bool {
        **self == SELMINUS_A::ADVREFP
    }
...
impl<'a> SELMINUS_W<'a> {
    ...
    #[doc = "Select ADVREFP"]
    #[inline(always)]
    pub fn advrefp(self) -> &'a mut W {
        self.variant(SELMINUS_A::ADVREFP)
    }
    #[doc = "Select DAC0"]
    #[inline(always)]
