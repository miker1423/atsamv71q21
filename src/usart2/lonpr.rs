#[doc = "Reader of register LONPR"]
pub type R = crate::R<u32, super::LONPR>;
#[doc = "Writer for register LONPR"]
pub type W = crate::W<u32, super::LONPR>;
#[doc = "Register LONPR `reset()`'s with value 0"]
impl crate::ResetValue for super::LONPR {
    type Type = u32;
    #[inline(always)]
