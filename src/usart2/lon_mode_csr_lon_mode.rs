#[doc = "Register `CSR_LON_MODE` reader"]
pub struct R(crate::R<LON_MODE_CSR_LON_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LON_MODE_CSR_LON_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<LON_MODE_CSR_LON_MODE_SPEC>> for R {
    fn from(reader: crate::R<LON_MODE_CSR_LON_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `LSFE` reader - LON Short Frame Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LCRCE` reader - LON CRC Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LTXD` reader - LON Transmission End Flag (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LCOL` reader - LON Collision Detected Flag (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LFET` reader - LON Frame Early Termination (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LRXD` reader - LON Reception End Flag (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LBLOVFE` reader - LON Backlog Overflow Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Channel Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lon_mode_csr_lon_mode](index.html) module"]
pub struct LON_MODE_CSR_LON_MODE_SPEC;
impl crate::RegisterSpec for LON_MODE_CSR_LON_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lon_mode_csr_lon_mode::R](R) reader structure"]
impl crate::Readable for LON_MODE_CSR_LON_MODE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CSR_LON_MODE to value 0"]
impl crate::Resettable for LON_MODE_CSR_LON_MODE_SPEC {
    #[inline(always)]
