...
impl core::convert::From<crate::R<SPI_MODE_MR_SPI_MODE_SPEC>> for R {
...
impl core::convert::From<crate::W<SPI_MODE_MR_SPI_MODE_SPEC>> for W {
...
#[doc = "`reset()` method sets MR_SPI_MODE to value 0"]
impl crate::Resettable for SPI_MODE_MR_SPI_MODE_SPEC {
    #[inline(always)]
