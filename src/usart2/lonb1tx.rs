#[doc = "Reader of register LONB1TX"]
pub type R = crate::R<u32, super::LONB1TX>;
#[doc = "Writer for register LONB1TX"]
pub type W = crate::W<u32, super::LONB1TX>;
#[doc = "Register LONB1TX `reset()`'s with value 0"]
impl crate::ResetValue for super::LONB1TX {
    type Type = u32;
    #[inline(always)]
