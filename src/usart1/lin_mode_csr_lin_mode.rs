...
impl core::convert::From<crate::R<LIN_MODE_CSR_LIN_MODE_SPEC>> for R {
    fn from(reader: crate::R<LIN_MODE_CSR_LIN_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `RXRDY` reader - Receiver Ready (cleared by reading US_THR)"]
...
#[doc = "Field `TIMEOUT` reader - Receiver Time-out (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINBK` reader - LIN Break Sent or LIN Break Received (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINID` reader - LIN Identifier Sent or LIN Identifier Received (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINTC` reader - LIN Transfer Completed (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINBE` reader - LIN Bit Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINISFE` reader - LIN Inconsistent Synch Field Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINIPE` reader - LIN Identifier Parity Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINCE` reader - LIN Checksum Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINSNRE` reader - LIN Slave Not Responding Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINSTE` reader - LIN Synch Tolerance Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
#[doc = "Field `LINHTE` reader - LIN Header Timeout Error (cleared by writing a one to bit US_CR.RSTSTA)"]
...
impl R {
    #[doc = "Bit 0 - Receiver Ready (cleared by reading US_THR)"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Receiver Time-out (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - LIN Break Sent or LIN Break Received (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linbk(&self) -> LINBK_R {
        LINBK_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 14 - LIN Identifier Sent or LIN Identifier Received (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linid(&self) -> LINID_R {
        LINID_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 15 - LIN Transfer Completed (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - LIN Bit Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linbe(&self) -> LINBE_R {
        LINBE_R::new(((self.bits >> 25) & 0x01) != 0)
    }
    #[doc = "Bit 26 - LIN Inconsistent Synch Field Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linisfe(&self) -> LINISFE_R {
        LINISFE_R::new(((self.bits >> 26) & 0x01) != 0)
    }
    #[doc = "Bit 27 - LIN Identifier Parity Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linipe(&self) -> LINIPE_R {
        LINIPE_R::new(((self.bits >> 27) & 0x01) != 0)
    }
    #[doc = "Bit 28 - LIN Checksum Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn lince(&self) -> LINCE_R {
        LINCE_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    #[doc = "Bit 29 - LIN Slave Not Responding Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linsnre(&self) -> LINSNRE_R {
        LINSNRE_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 30 - LIN Synch Tolerance Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
    pub fn linste(&self) -> LINSTE_R {
        LINSTE_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 31 - LIN Header Timeout Error (cleared by writing a one to bit US_CR.RSTSTA)"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CSR_LIN_MODE to value 0"]
impl crate::Resettable for LIN_MODE_CSR_LIN_MODE_SPEC {
    #[inline(always)]
