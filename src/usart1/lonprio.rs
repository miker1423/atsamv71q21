#[doc = "Reader of register LONPRIO"]
pub type R = crate::R<u32, super::LONPRIO>;
#[doc = "Writer for register LONPRIO"]
pub type W = crate::W<u32, super::LONPRIO>;
#[doc = "Register LONPRIO `reset()`'s with value 0"]
impl crate::ResetValue for super::LONPRIO {
    type Type = u32;
    #[inline(always)]
