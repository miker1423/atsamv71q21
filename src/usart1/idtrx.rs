#[doc = "Reader of register IDTRX"]
pub type R = crate::R<u32, super::IDTRX>;
#[doc = "Writer for register IDTRX"]
pub type W = crate::W<u32, super::IDTRX>;
#[doc = "Register IDTRX `reset()`'s with value 0"]
impl crate::ResetValue for super::IDTRX {
    type Type = u32;
    #[inline(always)]
