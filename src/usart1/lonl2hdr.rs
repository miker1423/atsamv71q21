#[doc = "Reader of register LONL2HDR"]
pub type R = crate::R<u32, super::LONL2HDR>;
#[doc = "Writer for register LONL2HDR"]
pub type W = crate::W<u32, super::LONL2HDR>;
#[doc = "Register LONL2HDR `reset()`'s with value 0"]
impl crate::ResetValue for super::LONL2HDR {
    type Type = u32;
    #[inline(always)]
