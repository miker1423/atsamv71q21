#[doc = "Reader of register LONDL"]
pub type R = crate::R<u32, super::LONDL>;
#[doc = "Writer for register LONDL"]
pub type W = crate::W<u32, super::LONDL>;
#[doc = "Register LONDL `reset()`'s with value 0"]
impl crate::ResetValue for super::LONDL {
    type Type = u32;
    #[inline(always)]
