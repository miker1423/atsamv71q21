#[doc = "Reader of register LONMR"]
pub type R = crate::R<u32, super::LONMR>;
#[doc = "Writer for register LONMR"]
pub type W = crate::W<u32, super::LONMR>;
#[doc = "Register LONMR `reset()`'s with value 0"]
impl crate::ResetValue for super::LONMR {
    type Type = u32;
    #[inline(always)]
