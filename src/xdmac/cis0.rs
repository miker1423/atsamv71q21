#[doc = "Register `CIS0` reader"]
pub struct R(crate::R<CIS0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS0_SPEC>> for R {
    fn from(reader: crate::R<CIS0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 0)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis0](index.html) module"]
pub struct CIS0_SPEC;
impl crate::RegisterSpec for CIS0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis0::R](R) reader structure"]
impl crate::Readable for CIS0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS0 to value 0"]
impl crate::Resettable for CIS0_SPEC {
    #[inline(always)]
