#[doc = "Reader of register CBC1"]
pub type R = crate::R<u32, super::CBC1>;
#[doc = "Writer for register CBC1"]
pub type W = crate::W<u32, super::CBC1>;
#[doc = "Register CBC1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC1 {
    type Type = u32;
    #[inline(always)]
