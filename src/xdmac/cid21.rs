#[doc = "Register `CID21` writer"]
pub struct W(crate::W<CID21_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID21_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID21_SPEC>> for W {
    fn from(writer: crate::W<CID21_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 21)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid21](index.html) module"]
pub struct CID21_SPEC;
impl crate::RegisterSpec for CID21_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid21::W](W) writer structure"]
impl crate::Writable for CID21_SPEC {
    type Writer = W;
}
