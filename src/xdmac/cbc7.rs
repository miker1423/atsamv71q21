#[doc = "Reader of register CBC7"]
pub type R = crate::R<u32, super::CBC7>;
#[doc = "Writer for register CBC7"]
pub type W = crate::W<u32, super::CBC7>;
#[doc = "Register CBC7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC7 {
    type Type = u32;
    #[inline(always)]
