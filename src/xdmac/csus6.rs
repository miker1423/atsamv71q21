#[doc = "Reader of register CSUS6"]
pub type R = crate::R<u32, super::CSUS6>;
#[doc = "Writer for register CSUS6"]
pub type W = crate::W<u32, super::CSUS6>;
#[doc = "Register CSUS6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CSUS6 {
    type Type = u32;
    #[inline(always)]
