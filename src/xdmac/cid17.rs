#[doc = "Register `CID17` writer"]
pub struct W(crate::W<CID17_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID17_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID17_SPEC>> for W {
    fn from(writer: crate::W<CID17_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 17)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid17](index.html) module"]
pub struct CID17_SPEC;
impl crate::RegisterSpec for CID17_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid17::W](W) writer structure"]
impl crate::Writable for CID17_SPEC {
    type Writer = W;
}
