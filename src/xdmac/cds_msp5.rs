#[doc = "Reader of register CDS_MSP5"]
pub type R = crate::R<u32, super::CDS_MSP5>;
#[doc = "Writer for register CDS_MSP5"]
pub type W = crate::W<u32, super::CDS_MSP5>;
#[doc = "Register CDS_MSP5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDS_MSP5 {
    type Type = u32;
    #[inline(always)]
