#[doc = "Register `CIS20` reader"]
pub struct R(crate::R<CIS20_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS20_SPEC>> for R {
    fn from(reader: crate::R<CIS20_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 20)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis20](index.html) module"]
pub struct CIS20_SPEC;
impl crate::RegisterSpec for CIS20_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis20::R](R) reader structure"]
impl crate::Readable for CIS20_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS20 to value 0"]
impl crate::Resettable for CIS20_SPEC {
    #[inline(always)]
