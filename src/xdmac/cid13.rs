#[doc = "Register `CID13` writer"]
pub struct W(crate::W<CID13_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID13_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID13_SPEC>> for W {
    fn from(writer: crate::W<CID13_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 13)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid13](index.html) module"]
pub struct CID13_SPEC;
impl crate::RegisterSpec for CID13_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid13::W](W) writer structure"]
impl crate::Writable for CID13_SPEC {
    type Writer = W;
}
