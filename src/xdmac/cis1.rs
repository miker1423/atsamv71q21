#[doc = "Register `CIS1` reader"]
pub struct R(crate::R<CIS1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS1_SPEC>> for R {
    fn from(reader: crate::R<CIS1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 1)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis1](index.html) module"]
pub struct CIS1_SPEC;
impl crate::RegisterSpec for CIS1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis1::R](R) reader structure"]
impl crate::Readable for CIS1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS1 to value 0"]
impl crate::Resettable for CIS1_SPEC {
    #[inline(always)]
