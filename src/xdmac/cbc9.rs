#[doc = "Reader of register CBC9"]
pub type R = crate::R<u32, super::CBC9>;
#[doc = "Writer for register CBC9"]
pub type W = crate::W<u32, super::CBC9>;
#[doc = "Register CBC9 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC9 {
    type Type = u32;
    #[inline(always)]
