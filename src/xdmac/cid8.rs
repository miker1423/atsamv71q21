#[doc = "Register `CID8` writer"]
pub struct W(crate::W<CID8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID8_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID8_SPEC>> for W {
    fn from(writer: crate::W<CID8_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 8)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid8](index.html) module"]
pub struct CID8_SPEC;
impl crate::RegisterSpec for CID8_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid8::W](W) writer structure"]
impl crate::Writable for CID8_SPEC {
    type Writer = W;
}
