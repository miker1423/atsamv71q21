#[doc = "Reader of register CUBC9"]
pub type R = crate::R<u32, super::CUBC9>;
#[doc = "Writer for register CUBC9"]
pub type W = crate::W<u32, super::CUBC9>;
#[doc = "Register CUBC9 `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC9 {
    type Type = u32;
    #[inline(always)]
