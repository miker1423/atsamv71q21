#[doc = "Register `CIE7` writer"]
pub struct W(crate::W<CIE7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE7_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE7_SPEC>> for W {
    fn from(writer: crate::W<CIE7_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 7)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie7](index.html) module"]
pub struct CIE7_SPEC;
impl crate::RegisterSpec for CIE7_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie7::W](W) writer structure"]
impl crate::Writable for CIE7_SPEC {
    type Writer = W;
}
