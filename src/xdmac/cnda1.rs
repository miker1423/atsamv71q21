#[doc = "Reader of register CNDA1"]
pub type R = crate::R<u32, super::CNDA1>;
#[doc = "Writer for register CNDA1"]
pub type W = crate::W<u32, super::CNDA1>;
#[doc = "Register CNDA1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA1 {
    type Type = u32;
    #[inline(always)]
