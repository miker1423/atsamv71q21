#[doc = "Register `CIM4` writer"]
pub struct W(crate::W<CIM4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM4_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM4_SPEC>> for W {
    fn from(writer: crate::W<CIM4_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 4)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim4](index.html) module"]
pub struct CIM4_SPEC;
impl crate::RegisterSpec for CIM4_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim4::W](W) writer structure"]
impl crate::Writable for CIM4_SPEC {
    type Writer = W;
}
