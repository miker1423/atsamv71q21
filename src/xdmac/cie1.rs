#[doc = "Register `CIE1` writer"]
pub struct W(crate::W<CIE1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE1_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE1_SPEC>> for W {
    fn from(writer: crate::W<CIE1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 1)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie1](index.html) module"]
pub struct CIE1_SPEC;
impl crate::RegisterSpec for CIE1_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie1::W](W) writer structure"]
impl crate::Writable for CIE1_SPEC {
    type Writer = W;
}
