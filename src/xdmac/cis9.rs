#[doc = "Register `CIS9` reader"]
pub struct R(crate::R<CIS9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS9_SPEC>> for R {
    fn from(reader: crate::R<CIS9_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 9)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis9](index.html) module"]
pub struct CIS9_SPEC;
impl crate::RegisterSpec for CIS9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis9::R](R) reader structure"]
impl crate::Readable for CIS9_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS9 to value 0"]
impl crate::Resettable for CIS9_SPEC {
    #[inline(always)]
