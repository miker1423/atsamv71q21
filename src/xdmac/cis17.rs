#[doc = "Register `CIS17` reader"]
pub struct R(crate::R<CIS17_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS17_SPEC>> for R {
    fn from(reader: crate::R<CIS17_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 17)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis17](index.html) module"]
pub struct CIS17_SPEC;
impl crate::RegisterSpec for CIS17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis17::R](R) reader structure"]
impl crate::Readable for CIS17_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS17 to value 0"]
impl crate::Resettable for CIS17_SPEC {
    #[inline(always)]
