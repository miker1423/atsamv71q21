#[doc = "Register `CIE6` writer"]
pub struct W(crate::W<CIE6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE6_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE6_SPEC>> for W {
    fn from(writer: crate::W<CIE6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 6)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie6](index.html) module"]
pub struct CIE6_SPEC;
impl crate::RegisterSpec for CIE6_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie6::W](W) writer structure"]
impl crate::Writable for CIE6_SPEC {
    type Writer = W;
}
