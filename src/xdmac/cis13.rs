#[doc = "Register `CIS13` reader"]
pub struct R(crate::R<CIS13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS13_SPEC>> for R {
    fn from(reader: crate::R<CIS13_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 13)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis13](index.html) module"]
pub struct CIS13_SPEC;
impl crate::RegisterSpec for CIS13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis13::R](R) reader structure"]
impl crate::Readable for CIS13_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS13 to value 0"]
impl crate::Resettable for CIS13_SPEC {
    #[inline(always)]
