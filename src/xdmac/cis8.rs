#[doc = "Register `CIS8` reader"]
pub struct R(crate::R<CIS8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS8_SPEC>> for R {
    fn from(reader: crate::R<CIS8_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 8)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis8](index.html) module"]
pub struct CIS8_SPEC;
impl crate::RegisterSpec for CIS8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis8::R](R) reader structure"]
impl crate::Readable for CIS8_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS8 to value 0"]
impl crate::Resettable for CIS8_SPEC {
    #[inline(always)]
