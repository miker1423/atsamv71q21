#[doc = "Register `CIS14` reader"]
pub struct R(crate::R<CIS14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS14_SPEC>> for R {
    fn from(reader: crate::R<CIS14_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 14)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis14](index.html) module"]
pub struct CIS14_SPEC;
impl crate::RegisterSpec for CIS14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis14::R](R) reader structure"]
impl crate::Readable for CIS14_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS14 to value 0"]
impl crate::Resettable for CIS14_SPEC {
    #[inline(always)]
