#[doc = "Register `CIS12` reader"]
pub struct R(crate::R<CIS12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS12_SPEC>> for R {
    fn from(reader: crate::R<CIS12_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 12)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis12](index.html) module"]
pub struct CIS12_SPEC;
impl crate::RegisterSpec for CIS12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis12::R](R) reader structure"]
impl crate::Readable for CIS12_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS12 to value 0"]
impl crate::Resettable for CIS12_SPEC {
    #[inline(always)]
