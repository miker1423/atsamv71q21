#[doc = "Register `CIM5` writer"]
pub struct W(crate::W<CIM5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM5_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM5_SPEC>> for W {
    fn from(writer: crate::W<CIM5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 5)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim5](index.html) module"]
pub struct CIM5_SPEC;
impl crate::RegisterSpec for CIM5_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim5::W](W) writer structure"]
impl crate::Writable for CIM5_SPEC {
    type Writer = W;
}
