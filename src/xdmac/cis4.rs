#[doc = "Register `CIS4` reader"]
pub struct R(crate::R<CIS4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS4_SPEC>> for R {
    fn from(reader: crate::R<CIS4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 4)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis4](index.html) module"]
pub struct CIS4_SPEC;
impl crate::RegisterSpec for CIS4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis4::R](R) reader structure"]
impl crate::Readable for CIS4_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS4 to value 0"]
impl crate::Resettable for CIS4_SPEC {
    #[inline(always)]
