#[doc = "Reader of register CDUS8"]
pub type R = crate::R<u32, super::CDUS8>;
#[doc = "Writer for register CDUS8"]
pub type W = crate::W<u32, super::CDUS8>;
#[doc = "Register CDUS8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS8 {
    type Type = u32;
    #[inline(always)]
