#[doc = "Reader of register CDUS5"]
pub type R = crate::R<u32, super::CDUS5>;
#[doc = "Writer for register CDUS5"]
pub type W = crate::W<u32, super::CDUS5>;
#[doc = "Register CDUS5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS5 {
    type Type = u32;
    #[inline(always)]
