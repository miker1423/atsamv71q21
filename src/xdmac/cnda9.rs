#[doc = "Reader of register CNDA9"]
pub type R = crate::R<u32, super::CNDA9>;
#[doc = "Writer for register CNDA9"]
pub type W = crate::W<u32, super::CNDA9>;
#[doc = "Register CNDA9 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA9 {
    type Type = u32;
    #[inline(always)]
