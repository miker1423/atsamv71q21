#[doc = "Reader of register CDUS4"]
pub type R = crate::R<u32, super::CDUS4>;
#[doc = "Writer for register CDUS4"]
pub type W = crate::W<u32, super::CDUS4>;
#[doc = "Register CDUS4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS4 {
    type Type = u32;
    #[inline(always)]
