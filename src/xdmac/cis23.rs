#[doc = "Register `CIS23` reader"]
pub struct R(crate::R<CIS23_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS23_SPEC>> for R {
    fn from(reader: crate::R<CIS23_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 23)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis23](index.html) module"]
pub struct CIS23_SPEC;
impl crate::RegisterSpec for CIS23_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis23::R](R) reader structure"]
impl crate::Readable for CIS23_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS23 to value 0"]
impl crate::Resettable for CIS23_SPEC {
    #[inline(always)]
