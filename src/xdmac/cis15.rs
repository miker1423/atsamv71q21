#[doc = "Register `CIS15` reader"]
pub struct R(crate::R<CIS15_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS15_SPEC>> for R {
    fn from(reader: crate::R<CIS15_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 15)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis15](index.html) module"]
pub struct CIS15_SPEC;
impl crate::RegisterSpec for CIS15_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis15::R](R) reader structure"]
impl crate::Readable for CIS15_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS15 to value 0"]
impl crate::Resettable for CIS15_SPEC {
    #[inline(always)]
