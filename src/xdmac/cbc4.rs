#[doc = "Reader of register CBC4"]
pub type R = crate::R<u32, super::CBC4>;
#[doc = "Writer for register CBC4"]
pub type W = crate::W<u32, super::CBC4>;
#[doc = "Register CBC4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC4 {
    type Type = u32;
    #[inline(always)]
