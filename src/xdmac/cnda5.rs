#[doc = "Reader of register CNDA5"]
pub type R = crate::R<u32, super::CNDA5>;
#[doc = "Writer for register CNDA5"]
pub type W = crate::W<u32, super::CNDA5>;
#[doc = "Register CNDA5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA5 {
    type Type = u32;
    #[inline(always)]
