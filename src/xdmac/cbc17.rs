#[doc = "Reader of register CBC17"]
pub type R = crate::R<u32, super::CBC17>;
#[doc = "Writer for register CBC17"]
pub type W = crate::W<u32, super::CBC17>;
#[doc = "Register CBC17 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC17 {
    type Type = u32;
    #[inline(always)]
