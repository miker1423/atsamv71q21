#[doc = "Register `CIE9` writer"]
pub struct W(crate::W<CIE9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE9_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE9_SPEC>> for W {
    fn from(writer: crate::W<CIE9_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 9)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie9](index.html) module"]
pub struct CIE9_SPEC;
impl crate::RegisterSpec for CIE9_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie9::W](W) writer structure"]
impl crate::Writable for CIE9_SPEC {
    type Writer = W;
}
