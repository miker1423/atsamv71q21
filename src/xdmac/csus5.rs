#[doc = "Reader of register CSUS5"]
pub type R = crate::R<u32, super::CSUS5>;
#[doc = "Writer for register CSUS5"]
pub type W = crate::W<u32, super::CSUS5>;
#[doc = "Register CSUS5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CSUS5 {
    type Type = u32;
    #[inline(always)]
