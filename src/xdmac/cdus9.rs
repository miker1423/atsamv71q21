#[doc = "Reader of register CDUS9"]
pub type R = crate::R<u32, super::CDUS9>;
#[doc = "Writer for register CDUS9"]
pub type W = crate::W<u32, super::CDUS9>;
#[doc = "Register CDUS9 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS9 {
    type Type = u32;
    #[inline(always)]
