#[doc = "Register `CIE3` writer"]
pub struct W(crate::W<CIE3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE3_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE3_SPEC>> for W {
    fn from(writer: crate::W<CIE3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 3)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie3](index.html) module"]
pub struct CIE3_SPEC;
impl crate::RegisterSpec for CIE3_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie3::W](W) writer structure"]
impl crate::Writable for CIE3_SPEC {
    type Writer = W;
}
