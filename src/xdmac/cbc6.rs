#[doc = "Reader of register CBC6"]
pub type R = crate::R<u32, super::CBC6>;
#[doc = "Writer for register CBC6"]
pub type W = crate::W<u32, super::CBC6>;
#[doc = "Register CBC6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC6 {
    type Type = u32;
    #[inline(always)]
