#[doc = "Register `CID9` writer"]
pub struct W(crate::W<CID9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID9_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID9_SPEC>> for W {
    fn from(writer: crate::W<CID9_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 9)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid9](index.html) module"]
pub struct CID9_SPEC;
impl crate::RegisterSpec for CID9_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid9::W](W) writer structure"]
impl crate::Writable for CID9_SPEC {
    type Writer = W;
}
