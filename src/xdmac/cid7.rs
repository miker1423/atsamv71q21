#[doc = "Register `CID7` writer"]
pub struct W(crate::W<CID7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID7_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID7_SPEC>> for W {
    fn from(writer: crate::W<CID7_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 7)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid7](index.html) module"]
pub struct CID7_SPEC;
impl crate::RegisterSpec for CID7_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid7::W](W) writer structure"]
impl crate::Writable for CID7_SPEC {
    type Writer = W;
}
