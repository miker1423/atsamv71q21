#[doc = "Register `CID18` writer"]
pub struct W(crate::W<CID18_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID18_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID18_SPEC>> for W {
    fn from(writer: crate::W<CID18_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 18)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid18](index.html) module"]
pub struct CID18_SPEC;
impl crate::RegisterSpec for CID18_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid18::W](W) writer structure"]
impl crate::Writable for CID18_SPEC {
    type Writer = W;
}
