#[doc = "Reader of register CUBC7"]
pub type R = crate::R<u32, super::CUBC7>;
#[doc = "Writer for register CUBC7"]
pub type W = crate::W<u32, super::CUBC7>;
#[doc = "Register CUBC7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC7 {
    type Type = u32;
    #[inline(always)]
