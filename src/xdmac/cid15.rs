#[doc = "Register `CID15` writer"]
pub struct W(crate::W<CID15_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID15_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID15_SPEC>> for W {
    fn from(writer: crate::W<CID15_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 15)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid15](index.html) module"]
pub struct CID15_SPEC;
impl crate::RegisterSpec for CID15_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid15::W](W) writer structure"]
impl crate::Writable for CID15_SPEC {
    type Writer = W;
}
