#[doc = "Reader of register CNDA7"]
pub type R = crate::R<u32, super::CNDA7>;
#[doc = "Writer for register CNDA7"]
pub type W = crate::W<u32, super::CNDA7>;
#[doc = "Register CNDA7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA7 {
    type Type = u32;
    #[inline(always)]
