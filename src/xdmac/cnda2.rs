#[doc = "Reader of register CNDA2"]
pub type R = crate::R<u32, super::CNDA2>;
#[doc = "Writer for register CNDA2"]
pub type W = crate::W<u32, super::CNDA2>;
#[doc = "Register CNDA2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA2 {
    type Type = u32;
    #[inline(always)]
