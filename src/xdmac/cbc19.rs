#[doc = "Reader of register CBC19"]
pub type R = crate::R<u32, super::CBC19>;
#[doc = "Writer for register CBC19"]
pub type W = crate::W<u32, super::CBC19>;
#[doc = "Register CBC19 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC19 {
    type Type = u32;
    #[inline(always)]
