#[doc = "Register `CIS19` reader"]
pub struct R(crate::R<CIS19_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS19_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS19_SPEC>> for R {
    fn from(reader: crate::R<CIS19_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 19)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis19](index.html) module"]
pub struct CIS19_SPEC;
impl crate::RegisterSpec for CIS19_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis19::R](R) reader structure"]
impl crate::Readable for CIS19_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS19 to value 0"]
impl crate::Resettable for CIS19_SPEC {
    #[inline(always)]
