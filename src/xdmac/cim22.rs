#[doc = "Register `CIM22` writer"]
pub struct W(crate::W<CIM22_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM22_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM22_SPEC>> for W {
    fn from(writer: crate::W<CIM22_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 22)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim22](index.html) module"]
pub struct CIM22_SPEC;
impl crate::RegisterSpec for CIM22_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim22::W](W) writer structure"]
impl crate::Writable for CIM22_SPEC {
    type Writer = W;
}
