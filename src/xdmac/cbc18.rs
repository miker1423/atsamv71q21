#[doc = "Reader of register CBC18"]
pub type R = crate::R<u32, super::CBC18>;
#[doc = "Writer for register CBC18"]
pub type W = crate::W<u32, super::CBC18>;
#[doc = "Register CBC18 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC18 {
    type Type = u32;
    #[inline(always)]
