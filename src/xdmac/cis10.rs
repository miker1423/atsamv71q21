#[doc = "Register `CIS10` reader"]
pub struct R(crate::R<CIS10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS10_SPEC>> for R {
    fn from(reader: crate::R<CIS10_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 10)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis10](index.html) module"]
pub struct CIS10_SPEC;
impl crate::RegisterSpec for CIS10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis10::R](R) reader structure"]
impl crate::Readable for CIS10_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS10 to value 0"]
impl crate::Resettable for CIS10_SPEC {
    #[inline(always)]
