#[doc = "Register `CID11` writer"]
pub struct W(crate::W<CID11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID11_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID11_SPEC>> for W {
    fn from(writer: crate::W<CID11_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 11)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid11](index.html) module"]
pub struct CID11_SPEC;
impl crate::RegisterSpec for CID11_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid11::W](W) writer structure"]
impl crate::Writable for CID11_SPEC {
    type Writer = W;
}
