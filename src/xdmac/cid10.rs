#[doc = "Register `CID10` writer"]
pub struct W(crate::W<CID10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID10_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID10_SPEC>> for W {
    fn from(writer: crate::W<CID10_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 10)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid10](index.html) module"]
pub struct CID10_SPEC;
impl crate::RegisterSpec for CID10_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid10::W](W) writer structure"]
impl crate::Writable for CID10_SPEC {
    type Writer = W;
}
