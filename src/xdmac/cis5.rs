#[doc = "Register `CIS5` reader"]
pub struct R(crate::R<CIS5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS5_SPEC>> for R {
    fn from(reader: crate::R<CIS5_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 5)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis5](index.html) module"]
pub struct CIS5_SPEC;
impl crate::RegisterSpec for CIS5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis5::R](R) reader structure"]
impl crate::Readable for CIS5_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS5 to value 0"]
impl crate::Resettable for CIS5_SPEC {
    #[inline(always)]
