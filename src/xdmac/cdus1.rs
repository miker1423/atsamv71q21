#[doc = "Reader of register CDUS1"]
pub type R = crate::R<u32, super::CDUS1>;
#[doc = "Writer for register CDUS1"]
pub type W = crate::W<u32, super::CDUS1>;
#[doc = "Register CDUS1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS1 {
    type Type = u32;
    #[inline(always)]
