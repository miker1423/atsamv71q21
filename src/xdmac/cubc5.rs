#[doc = "Reader of register CUBC5"]
pub type R = crate::R<u32, super::CUBC5>;
#[doc = "Writer for register CUBC5"]
pub type W = crate::W<u32, super::CUBC5>;
#[doc = "Register CUBC5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC5 {
    type Type = u32;
    #[inline(always)]
