#[doc = "Reader of register CBC16"]
pub type R = crate::R<u32, super::CBC16>;
#[doc = "Writer for register CBC16"]
pub type W = crate::W<u32, super::CBC16>;
#[doc = "Register CBC16 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC16 {
    type Type = u32;
    #[inline(always)]
