#[doc = "Register `CIM9` writer"]
pub struct W(crate::W<CIM9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM9_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM9_SPEC>> for W {
    fn from(writer: crate::W<CIM9_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 9)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim9](index.html) module"]
pub struct CIM9_SPEC;
impl crate::RegisterSpec for CIM9_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim9::W](W) writer structure"]
impl crate::Writable for CIM9_SPEC {
    type Writer = W;
}
