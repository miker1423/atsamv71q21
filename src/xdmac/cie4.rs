#[doc = "Register `CIE4` writer"]
pub struct W(crate::W<CIE4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE4_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE4_SPEC>> for W {
    fn from(writer: crate::W<CIE4_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 4)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie4](index.html) module"]
pub struct CIE4_SPEC;
impl crate::RegisterSpec for CIE4_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie4::W](W) writer structure"]
impl crate::Writable for CIE4_SPEC {
    type Writer = W;
}
