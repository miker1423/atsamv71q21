#[doc = "Reader of register CNDA3"]
pub type R = crate::R<u32, super::CNDA3>;
#[doc = "Writer for register CNDA3"]
pub type W = crate::W<u32, super::CNDA3>;
#[doc = "Register CNDA3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA3 {
    type Type = u32;
    #[inline(always)]
