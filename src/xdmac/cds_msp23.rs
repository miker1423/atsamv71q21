#[doc = "Reader of register CDS_MSP23"]
pub type R = crate::R<u32, super::CDS_MSP23>;
#[doc = "Writer for register CDS_MSP23"]
pub type W = crate::W<u32, super::CDS_MSP23>;
#[doc = "Register CDS_MSP23 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDS_MSP23 {
    type Type = u32;
    #[inline(always)]
