#[doc = "Reader of register CBC15"]
pub type R = crate::R<u32, super::CBC15>;
#[doc = "Writer for register CBC15"]
pub type W = crate::W<u32, super::CBC15>;
#[doc = "Register CBC15 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC15 {
    type Type = u32;
    #[inline(always)]
