#[doc = "Register `CIS22` reader"]
pub struct R(crate::R<CIS22_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS22_SPEC>> for R {
    fn from(reader: crate::R<CIS22_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 22)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis22](index.html) module"]
pub struct CIS22_SPEC;
impl crate::RegisterSpec for CIS22_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis22::R](R) reader structure"]
impl crate::Readable for CIS22_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS22 to value 0"]
impl crate::Resettable for CIS22_SPEC {
    #[inline(always)]
