#[doc = "Register `CIM23` writer"]
pub struct W(crate::W<CIM23_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM23_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM23_SPEC>> for W {
    fn from(writer: crate::W<CIM23_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 23)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim23](index.html) module"]
pub struct CIM23_SPEC;
impl crate::RegisterSpec for CIM23_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim23::W](W) writer structure"]
impl crate::Writable for CIM23_SPEC {
    type Writer = W;
}
