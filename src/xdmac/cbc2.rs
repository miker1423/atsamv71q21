#[doc = "Reader of register CBC2"]
pub type R = crate::R<u32, super::CBC2>;
#[doc = "Writer for register CBC2"]
pub type W = crate::W<u32, super::CBC2>;
#[doc = "Register CBC2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC2 {
    type Type = u32;
    #[inline(always)]
