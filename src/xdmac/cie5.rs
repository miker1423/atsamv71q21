#[doc = "Register `CIE5` writer"]
pub struct W(crate::W<CIE5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE5_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE5_SPEC>> for W {
    fn from(writer: crate::W<CIE5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 5)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie5](index.html) module"]
pub struct CIE5_SPEC;
impl crate::RegisterSpec for CIE5_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie5::W](W) writer structure"]
impl crate::Writable for CIE5_SPEC {
    type Writer = W;
}
