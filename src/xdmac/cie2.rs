#[doc = "Register `CIE2` writer"]
pub struct W(crate::W<CIE2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE2_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE2_SPEC>> for W {
    fn from(writer: crate::W<CIE2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 2)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie2](index.html) module"]
pub struct CIE2_SPEC;
impl crate::RegisterSpec for CIE2_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie2::W](W) writer structure"]
impl crate::Writable for CIE2_SPEC {
    type Writer = W;
}
