#[doc = "Register `CIS3` reader"]
pub struct R(crate::R<CIS3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS3_SPEC>> for R {
    fn from(reader: crate::R<CIS3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 3)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis3](index.html) module"]
pub struct CIS3_SPEC;
impl crate::RegisterSpec for CIS3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis3::R](R) reader structure"]
impl crate::Readable for CIS3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS3 to value 0"]
impl crate::Resettable for CIS3_SPEC {
    #[inline(always)]
