#[doc = "Register `CIS21` reader"]
pub struct R(crate::R<CIS21_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS21_SPEC>> for R {
    fn from(reader: crate::R<CIS21_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 21)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis21](index.html) module"]
pub struct CIS21_SPEC;
impl crate::RegisterSpec for CIS21_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis21::R](R) reader structure"]
impl crate::Readable for CIS21_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS21 to value 0"]
impl crate::Resettable for CIS21_SPEC {
    #[inline(always)]
