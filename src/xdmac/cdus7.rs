#[doc = "Reader of register CDUS7"]
pub type R = crate::R<u32, super::CDUS7>;
#[doc = "Writer for register CDUS7"]
pub type W = crate::W<u32, super::CDUS7>;
#[doc = "Register CDUS7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS7 {
    type Type = u32;
    #[inline(always)]
