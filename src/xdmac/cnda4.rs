#[doc = "Reader of register CNDA4"]
pub type R = crate::R<u32, super::CNDA4>;
#[doc = "Writer for register CNDA4"]
pub type W = crate::W<u32, super::CNDA4>;
#[doc = "Register CNDA4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA4 {
    type Type = u32;
    #[inline(always)]
