#[doc = "Reader of register CUBC6"]
pub type R = crate::R<u32, super::CUBC6>;
#[doc = "Writer for register CUBC6"]
pub type W = crate::W<u32, super::CUBC6>;
#[doc = "Register CUBC6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC6 {
    type Type = u32;
    #[inline(always)]
