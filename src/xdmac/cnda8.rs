#[doc = "Reader of register CNDA8"]
pub type R = crate::R<u32, super::CNDA8>;
#[doc = "Writer for register CNDA8"]
pub type W = crate::W<u32, super::CNDA8>;
#[doc = "Register CNDA8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA8 {
    type Type = u32;
    #[inline(always)]
