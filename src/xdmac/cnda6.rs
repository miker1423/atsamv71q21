#[doc = "Reader of register CNDA6"]
pub type R = crate::R<u32, super::CNDA6>;
#[doc = "Writer for register CNDA6"]
pub type W = crate::W<u32, super::CNDA6>;
#[doc = "Register CNDA6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA6 {
    type Type = u32;
    #[inline(always)]
