#[doc = "Register `CIE0` writer"]
pub struct W(crate::W<CIE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIE0_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIE0_SPEC>> for W {
    fn from(writer: crate::W<CIE0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Enable Register (chid = 0)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cie0](index.html) module"]
pub struct CIE0_SPEC;
impl crate::RegisterSpec for CIE0_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cie0::W](W) writer structure"]
impl crate::Writable for CIE0_SPEC {
    type Writer = W;
}
