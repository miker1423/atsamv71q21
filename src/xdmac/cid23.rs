#[doc = "Register `CID23` writer"]
pub struct W(crate::W<CID23_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID23_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID23_SPEC>> for W {
    fn from(writer: crate::W<CID23_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 23)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid23](index.html) module"]
pub struct CID23_SPEC;
impl crate::RegisterSpec for CID23_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid23::W](W) writer structure"]
impl crate::Writable for CID23_SPEC {
    type Writer = W;
}
