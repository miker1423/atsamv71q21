#[doc = "Reader of register CUBC1"]
pub type R = crate::R<u32, super::CUBC1>;
#[doc = "Writer for register CUBC1"]
pub type W = crate::W<u32, super::CUBC1>;
#[doc = "Register CUBC1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC1 {
    type Type = u32;
    #[inline(always)]
