#[doc = "Reader of register CDUS6"]
pub type R = crate::R<u32, super::CDUS6>;
#[doc = "Writer for register CDUS6"]
pub type W = crate::W<u32, super::CDUS6>;
#[doc = "Register CDUS6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS6 {
    type Type = u32;
    #[inline(always)]
