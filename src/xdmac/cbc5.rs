#[doc = "Reader of register CBC5"]
pub type R = crate::R<u32, super::CBC5>;
#[doc = "Writer for register CBC5"]
pub type W = crate::W<u32, super::CBC5>;
#[doc = "Register CBC5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC5 {
    type Type = u32;
    #[inline(always)]
