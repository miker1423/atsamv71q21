#[doc = "Register `CIS6` reader"]
pub struct R(crate::R<CIS6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS6_SPEC>> for R {
    fn from(reader: crate::R<CIS6_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 6)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis6](index.html) module"]
pub struct CIS6_SPEC;
impl crate::RegisterSpec for CIS6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis6::R](R) reader structure"]
impl crate::Readable for CIS6_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS6 to value 0"]
impl crate::Resettable for CIS6_SPEC {
    #[inline(always)]
