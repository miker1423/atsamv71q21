#[doc = "Register `CID12` writer"]
pub struct W(crate::W<CID12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID12_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID12_SPEC>> for W {
    fn from(writer: crate::W<CID12_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 12)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid12](index.html) module"]
pub struct CID12_SPEC;
impl crate::RegisterSpec for CID12_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid12::W](W) writer structure"]
impl crate::Writable for CID12_SPEC {
    type Writer = W;
}
