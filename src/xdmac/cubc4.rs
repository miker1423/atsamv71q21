#[doc = "Reader of register CUBC4"]
pub type R = crate::R<u32, super::CUBC4>;
#[doc = "Writer for register CUBC4"]
pub type W = crate::W<u32, super::CUBC4>;
#[doc = "Register CUBC4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC4 {
    type Type = u32;
    #[inline(always)]
