#[doc = "Register `CIM14` writer"]
pub struct W(crate::W<CIM14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM14_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM14_SPEC>> for W {
    fn from(writer: crate::W<CIM14_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 14)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim14](index.html) module"]
pub struct CIM14_SPEC;
impl crate::RegisterSpec for CIM14_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim14::W](W) writer structure"]
impl crate::Writable for CIM14_SPEC {
    type Writer = W;
}
