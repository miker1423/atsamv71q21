#[doc = "Register `CIM1` writer"]
pub struct W(crate::W<CIM1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM1_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM1_SPEC>> for W {
    fn from(writer: crate::W<CIM1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 1)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim1](index.html) module"]
pub struct CIM1_SPEC;
impl crate::RegisterSpec for CIM1_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim1::W](W) writer structure"]
impl crate::Writable for CIM1_SPEC {
    type Writer = W;
}
