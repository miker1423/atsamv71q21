#[doc = "Reader of register CDUS3"]
pub type R = crate::R<u32, super::CDUS3>;
#[doc = "Writer for register CDUS3"]
pub type W = crate::W<u32, super::CDUS3>;
#[doc = "Register CDUS3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS3 {
    type Type = u32;
    #[inline(always)]
