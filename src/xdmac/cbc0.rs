#[doc = "Reader of register CBC0"]
pub type R = crate::R<u32, super::CBC0>;
#[doc = "Writer for register CBC0"]
pub type W = crate::W<u32, super::CBC0>;
#[doc = "Register CBC0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC0 {
    type Type = u32;
    #[inline(always)]
