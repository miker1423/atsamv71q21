#[doc = "Register `CIS7` reader"]
pub struct R(crate::R<CIS7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS7_SPEC>> for R {
    fn from(reader: crate::R<CIS7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 7)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis7](index.html) module"]
pub struct CIS7_SPEC;
impl crate::RegisterSpec for CIS7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis7::R](R) reader structure"]
impl crate::Readable for CIS7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS7 to value 0"]
impl crate::Resettable for CIS7_SPEC {
    #[inline(always)]
