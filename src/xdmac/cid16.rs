#[doc = "Register `CID16` writer"]
pub struct W(crate::W<CID16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID16_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID16_SPEC>> for W {
    fn from(writer: crate::W<CID16_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 16)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid16](index.html) module"]
pub struct CID16_SPEC;
impl crate::RegisterSpec for CID16_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid16::W](W) writer structure"]
impl crate::Writable for CID16_SPEC {
    type Writer = W;
}
