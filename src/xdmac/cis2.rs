#[doc = "Register `CIS2` reader"]
pub struct R(crate::R<CIS2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS2_SPEC>> for R {
    fn from(reader: crate::R<CIS2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 2)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis2](index.html) module"]
pub struct CIS2_SPEC;
impl crate::RegisterSpec for CIS2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis2::R](R) reader structure"]
impl crate::Readable for CIS2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS2 to value 0"]
impl crate::Resettable for CIS2_SPEC {
    #[inline(always)]
