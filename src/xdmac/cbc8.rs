#[doc = "Reader of register CBC8"]
pub type R = crate::R<u32, super::CBC8>;
#[doc = "Writer for register CBC8"]
pub type W = crate::W<u32, super::CBC8>;
#[doc = "Register CBC8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC8 {
    type Type = u32;
    #[inline(always)]
