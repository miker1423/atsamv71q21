#[doc = "Reader of register CSUS8"]
pub type R = crate::R<u32, super::CSUS8>;
#[doc = "Writer for register CSUS8"]
pub type W = crate::W<u32, super::CSUS8>;
#[doc = "Register CSUS8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CSUS8 {
    type Type = u32;
    #[inline(always)]
