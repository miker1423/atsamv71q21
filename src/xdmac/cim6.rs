#[doc = "Register `CIM6` writer"]
pub struct W(crate::W<CIM6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIM6_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CIM6_SPEC>> for W {
    fn from(writer: crate::W<CIM6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Mask Register (chid = 6)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cim6](index.html) module"]
pub struct CIM6_SPEC;
impl crate::RegisterSpec for CIM6_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cim6::W](W) writer structure"]
impl crate::Writable for CIM6_SPEC {
    type Writer = W;
}
