#[doc = "Register `CIS11` reader"]
pub struct R(crate::R<CIS11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS11_SPEC>> for R {
    fn from(reader: crate::R<CIS11_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 11)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis11](index.html) module"]
pub struct CIS11_SPEC;
impl crate::RegisterSpec for CIS11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis11::R](R) reader structure"]
impl crate::Readable for CIS11_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS11 to value 0"]
impl crate::Resettable for CIS11_SPEC {
    #[inline(always)]
