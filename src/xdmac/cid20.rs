#[doc = "Register `CID20` writer"]
pub struct W(crate::W<CID20_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID20_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID20_SPEC>> for W {
    fn from(writer: crate::W<CID20_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 20)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid20](index.html) module"]
pub struct CID20_SPEC;
impl crate::RegisterSpec for CID20_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid20::W](W) writer structure"]
impl crate::Writable for CID20_SPEC {
    type Writer = W;
}
