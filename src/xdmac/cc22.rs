#[doc = "Reader of register CC22"]
pub type R = crate::R<u32, super::CC22>;
#[doc = "Writer for register CC22"]
pub type W = crate::W<u32, super::CC22>;
#[doc = "Register CC22 `reset()`'s with value 0"]
impl crate::ResetValue for super::CC22 {
    type Type = u32;
    #[inline(always)]
...
pub type PROT_R = crate::R<bool, PROT_A>;
impl PROT_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
