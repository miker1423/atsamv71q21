#[doc = "Register `CID6` writer"]
pub struct W(crate::W<CID6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID6_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID6_SPEC>> for W {
    fn from(writer: crate::W<CID6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 6)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid6](index.html) module"]
pub struct CID6_SPEC;
impl crate::RegisterSpec for CID6_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid6::W](W) writer structure"]
impl crate::Writable for CID6_SPEC {
    type Writer = W;
}
