#[doc = "Register `CIS18` reader"]
pub struct R(crate::R<CIS18_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS18_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CIS18_SPEC>> for R {
    fn from(reader: crate::R<CIS18_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel Interrupt Status Register (chid = 18)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cis18](index.html) module"]
pub struct CIS18_SPEC;
impl crate::RegisterSpec for CIS18_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cis18::R](R) reader structure"]
impl crate::Readable for CIS18_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CIS18 to value 0"]
impl crate::Resettable for CIS18_SPEC {
    #[inline(always)]
