#[doc = "Reader of register CSUS7"]
pub type R = crate::R<u32, super::CSUS7>;
#[doc = "Writer for register CSUS7"]
pub type W = crate::W<u32, super::CSUS7>;
#[doc = "Register CSUS7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CSUS7 {
    type Type = u32;
    #[inline(always)]
