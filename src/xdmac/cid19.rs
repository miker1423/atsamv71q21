#[doc = "Register `CID19` writer"]
pub struct W(crate::W<CID19_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CID19_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CID19_SPEC>> for W {
    fn from(writer: crate::W<CID19_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Interrupt Disable Register (chid = 19)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cid19](index.html) module"]
pub struct CID19_SPEC;
impl crate::RegisterSpec for CID19_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [cid19::W](W) writer structure"]
impl crate::Writable for CID19_SPEC {
    type Writer = W;
}
