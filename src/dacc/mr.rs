...
pub enum MAXS0_A {
    #[doc = "0: Triggered by selected event"]
    TRIG_EVENT = 0,
...
impl<'a> MAXS0_W<'a> {
    ...
    #[doc = "Triggered by selected event"]
    #[inline(always)]
...
pub enum WORD_A {
    ...
    DISABLED = 0,
    #[doc = "1: Two data to convert are written to the FIFO per access to DACC (reduces number of requests to DMA and the number of system bus accesses)"]
    ENABLED = 1,
}
...
impl<'a> WORD_W<'a> {
    ...
    #[doc = "Two data to convert are written to the FIFO per access to DACC (reduces number of requests to DMA and the number of system bus accesses)"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIFF_A {
    #[doc = "0: DAC0 and DAC1 outputs can be separately configured"]
    DISABLED = 0,
    #[doc = "1: DACP and DACN outputs are configured by the channel 0 value."]
    ENABLED = 1,
}
...
impl<'a> DIFF_W<'a> {
    ...
    #[doc = "DAC0 and DAC1 outputs can be separately configured"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(DIFF_A::DISABLED)
    }
    #[doc = "DACP and DACN outputs are configured by the channel 0 value."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
