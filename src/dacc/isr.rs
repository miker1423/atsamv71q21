...
#[doc = "Field `ENDTX0` reader - End of DMA Interrupt Flag of channel 0"]
...
#[doc = "Field `ENDTX1` reader - End of DMA Interrupt Flag of channel 1"]
...
#[doc = "Field `TXBUFE0` reader - Transmit Buffer Empty of channel 0"]
...
#[doc = "Field `TXBUFE1` reader - Transmit Buffer Empty of channel 1"]
...
impl R {
    ...
    #[doc = "Bit 8 - End of DMA Interrupt Flag of channel 0"]
    #[inline(always)]
    pub fn endtx0(&self) -> ENDTX0_R {
        ENDTX0_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - End of DMA Interrupt Flag of channel 1"]
    #[inline(always)]
    pub fn endtx1(&self) -> ENDTX1_R {
        ENDTX1_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Transmit Buffer Empty of channel 0"]
    #[inline(always)]
    pub fn txbufe0(&self) -> TXBUFE0_R {
        TXBUFE0_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - Transmit Buffer Empty of channel 1"]
    #[inline(always)]
