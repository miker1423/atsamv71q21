...
impl TRGSEL0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, TRGSEL0_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(TRGSEL0_A::TRGSEL0),
            1 => Val(TRGSEL0_A::TRGSEL1),
            2 => Val(TRGSEL0_A::TRGSEL2),
            3 => Val(TRGSEL0_A::TRGSEL3),
            4 => Val(TRGSEL0_A::TRGSEL4),
            5 => Val(TRGSEL0_A::TRGSEL5),
            6 => Val(TRGSEL0_A::TRGSEL6),
            i => Res(i),
        }
    }
...
impl TRGSEL1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, TRGSEL1_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(TRGSEL1_A::TRGSEL0),
            1 => Val(TRGSEL1_A::TRGSEL1),
            2 => Val(TRGSEL1_A::TRGSEL2),
            3 => Val(TRGSEL1_A::TRGSEL3),
            4 => Val(TRGSEL1_A::TRGSEL4),
            5 => Val(TRGSEL1_A::TRGSEL5),
            6 => Val(TRGSEL1_A::TRGSEL6),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `TRGSEL0`"]
