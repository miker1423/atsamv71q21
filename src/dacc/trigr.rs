...
impl core::convert::From<crate::R<TRIGR_SPEC>> for R {
...
impl core::convert::From<crate::W<TRIGR_SPEC>> for W {
...
pub enum TRGEN0_A {
    #[doc = "0: External trigger mode disabled. DAC is in free running mode."]
    DIS = 0,
...
impl<'a> TRGEN0_W<'a> {
    ...
    #[doc = "External trigger mode disabled. DAC is in free running mode."]
    #[inline(always)]
...
impl TRGSEL0_R {
    ...
    pub fn variant(&self) -> Option<TRGSEL0_A> {
        match self.bits {
            0 => Some(TRGSEL0_A::TRGSEL0),
            1 => Some(TRGSEL0_A::TRGSEL1),
            2 => Some(TRGSEL0_A::TRGSEL2),
            3 => Some(TRGSEL0_A::TRGSEL3),
            4 => Some(TRGSEL0_A::TRGSEL4),
            5 => Some(TRGSEL0_A::TRGSEL5),
            6 => Some(TRGSEL0_A::TRGSEL6),
            _ => None,
        }
    }
...
impl TRGSEL1_R {
    ...
    pub fn variant(&self) -> Option<TRGSEL1_A> {
        match self.bits {
            0 => Some(TRGSEL1_A::TRGSEL0),
            1 => Some(TRGSEL1_A::TRGSEL1),
            2 => Some(TRGSEL1_A::TRGSEL2),
            3 => Some(TRGSEL1_A::TRGSEL3),
            4 => Some(TRGSEL1_A::TRGSEL4),
            5 => Some(TRGSEL1_A::TRGSEL5),
            6 => Some(TRGSEL1_A::TRGSEL6),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `TRGSEL0`"]
