#[doc = "Reader of register MATRIX_PRBS7"]
pub type R = crate::R<u32, super::MATRIX_PRBS7>;
#[doc = "Writer for register MATRIX_PRBS7"]
pub type W = crate::W<u32, super::MATRIX_PRBS7>;
#[doc = "Register MATRIX_PRBS7 `reset()`'s with value 0x3333"]
impl crate::ResetValue for super::MATRIX_PRBS7 {
    type Type = u32;
    #[inline(always)]
