#[doc = "Reader of register MATRIX_PRBS1"]
pub type R = crate::R<u32, super::MATRIX_PRBS1>;
#[doc = "Writer for register MATRIX_PRBS1"]
pub type W = crate::W<u32, super::MATRIX_PRBS1>;
#[doc = "Register MATRIX_PRBS1 `reset()`'s with value 0x3333"]
impl crate::ResetValue for super::MATRIX_PRBS1 {
    type Type = u32;
    #[inline(always)]
