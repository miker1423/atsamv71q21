#[doc = "Register `MATRIX_PRBS2` reader"]
pub struct R(crate::R<MATRIX_PRBS2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATRIX_PRBS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATRIX_PRBS2_SPEC>> for R {
    fn from(reader: crate::R<MATRIX_PRBS2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATRIX_PRBS2` writer"]
pub struct W(crate::W<MATRIX_PRBS2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATRIX_PRBS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATRIX_PRBS2_SPEC>> for W {
    fn from(writer: crate::W<MATRIX_PRBS2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Priority Register B for Slave 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [matrix_prbs2](index.html) module"]
pub struct MATRIX_PRBS2_SPEC;
impl crate::RegisterSpec for MATRIX_PRBS2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matrix_prbs2::R](R) reader structure"]
impl crate::Readable for MATRIX_PRBS2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [matrix_prbs2::W](W) writer structure"]
impl crate::Writable for MATRIX_PRBS2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MATRIX_PRBS2 to value 0x3333"]
impl crate::Resettable for MATRIX_PRBS2_SPEC {
    #[inline(always)]
